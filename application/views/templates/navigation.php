   ...
   <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-files-o fa-fw"></i> Peminjaman Khusus<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
        		 <a href="<?php echo site_url('formulir'); ?>"><i class="fa fa-table fa-fw"></i> Formulir Peminjaman</a>
            	    </li>
                    <li>
        		 <a href="<?php echo site_url('listPeminjaman'); ?>"><i class="fa fa-table fa-fw"></i> List Peminjaman Khusus</a>
            	    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
